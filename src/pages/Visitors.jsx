...
import { DoorOpen, Search, Building2, Clock, LogIn, LogOut, User, Phone, Car, MoreVertical, Trash2 } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export default function Visitors() {
  ...
  const filteredVisitors = visitors.filter(v => {
    ...
    const matchesBuilding = filterBuilding === 'all' || v.building_id === filterBuilding;
  ...
  if (isLoading) {
    return (
      <div className="space-y-8">
        <PageHeader title="Visitors" subtitle="Manage visitor access" />
  ...
  return (
    <div className="space-y-6">
      <PageHeader 
        title="Visitors" 
        subtitle={`${activeVisitors} currently on-site`}
