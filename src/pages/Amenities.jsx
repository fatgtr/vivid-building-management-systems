...
import { Calendar, Search, Building2, MoreVertical, Pencil, Trash2, Users, Clock, DollarSign, MapPin, Dumbbell } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export default function Amenities() {
  ...
  if (isLoading) {
    return (
      <div className="space-y-8">
        <PageHeader title="Amenities" subtitle="Manage building amenities and bookings" />
  ...
  return (
    <div className="space-y-6">
      <PageHeader 
        title="Amenities" 
        subtitle={`${amenities.length} amenities, ${bookings.filter(b => b.status === 'pending').length} pending bookings`}
