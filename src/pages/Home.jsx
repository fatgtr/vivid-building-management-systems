...
export default function Home() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'var(--keyvision-bg-light)' }}>
      {/* Top Navigation */}
      ...
      {/* Hero Section */}
      <section className="relative keyvision-gradient-bg text-white py-24 lg:py-32 px-4 sm:px-6 lg:px-8 overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <Button size="lg" className="bg-white hover:bg-gray-100 text-lg px-8 py-6 font-semibold shadow-xl" style={{ color: 'var(--keyvision-blue-start)' }}>
                  Book a Demo
                </Button>
                <Button size="lg" variant="outline" className="border-2 border-white text-white hover:bg-white/20 text-lg px-8 py-6 font-semibold">
                  See How It Works
                </Button>
              </div>
            </div>
      ...
      <section className="py-24" style={{ backgroundColor: 'var(--keyvision-bg-light)' }}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="keyvision-card p-12 text-center">
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl sm:text-5xl font-bold text-center mb-20" style={{ color: 'var(--keyvision-text-dark)' }}>Less admin. More building management.</h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <div className="keyvision-card p-6">
            ...
            <div className="flex justify-center">
              <div className="relative">
                <div className="absolute -inset-4 keyvision-gradient-bg opacity-20 blur-2xl rounded-3xl"></div>
                <img 
                  src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?q=80&w=2073&auto=format&fit=crop" 
                  alt="Building manager on site" 
                  className="relative rounded-2xl shadow-2xl w-full max-w-lg object-cover h-[600px]"
                />
              </div>
            </div>
          </div>
      ...
      <section id="solutions" className="py-24 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl sm:text-5xl font-bold mb-4" style={{ color: 'var(--keyvision-text-dark)' }}>Who Vivid is built for</h2>
            <p className="text-xl max-w-3xl mx-auto" style={{ color: 'var(--keyvision-text-light)' }}>
              Supporting everyone involved in building management
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="keyvision-card">
              <CardContent className="p-10 text-center">
                <div className="inline-flex p-5 rounded-2xl bg-blue-50 mb-6">
                  <UserCog className="w-12 h-12" style={{ color: 'var(--keyvision-blue-start)' }} />
                </div>
            ...
            <Card className="keyvision-card">
              <CardContent className="p-10 text-center">
                <div className="inline-flex p-5 rounded-2xl bg-green-50 mb-6">
            ...
            <Card className="keyvision-card">
              <CardContent className="p-10 text-center">
                <div className="inline-flex p-5 rounded-2xl bg-indigo-50 mb-6">
                  <HomeIcon className="w-12 h-12" style={{ color: 'var(--keyvision-blue-end)' }} />
                </div>
      ...
      <section id="features" className="py-24 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: 'var(--keyvision-bg-light)' }}>
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl sm:text-5xl font-bold mb-4" style={{ color: 'var(--keyvision-text-dark)' }}>What Vivid helps you do</h2>
            <p className="text-xl max-w-3xl mx-auto" style={{ color: 'var(--keyvision-text-light)' }}>
              Designed to support building managers in their day-to-day operations
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="keyvision-card p-8 text-center">
              <div className="inline-flex p-4 rounded-2xl bg-blue-50 mb-6">
                <ClipboardCheck className="w-10 h-10" style={{ color: 'var(--keyvision-blue-start)' }} />
              </div>
            ...
            <div className="keyvision-card p-8 text-center">
              <div className="inline-flex p-4 rounded-2xl bg-indigo-50 mb-6">
                <MessageSquare className="w-10 h-10" style={{ color: 'var(--keyvision-blue-end)' }} />
              </div>
            ...
            <div className="keyvision-card p-8 text-center">
              <div className="inline-flex p-4 rounded-2xl bg-orange-50 mb-6">
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 keyvision-gradient-bg text-white relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          <h2 className="text-4xl sm:text-5xl font-bold mb-6">Designed to scale with real buildings</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all">
              ...
              <p className="text-lg font-semibold">Small strata schemes</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all">
              <div className="inline-flex p-4 rounded-full bg-white/10 mb-4">
                <Building2 className="w-10 h-10 text-white" />
              </div>
              <p className="text-lg font-semibold">Medium residential buildings</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all">
              <div className="inline-flex p-4 rounded-full bg-white/10 mb-4">
                <Building2 className="w-10 h-10 text-white" />
              </div>
              <p className="text-lg font-semibold">Large strata and BMC managed buildings</p>
            </div>
          </div>
      ...
      {/* What's coming next */}
      <section id="whats-next" className="py-24 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: 'var(--keyvision-bg-light)' }}>
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl sm:text-5xl font-bold mb-12" style={{ color: 'var(--keyvision-text-dark)' }}>What's coming next</h2>
          <div className="keyvision-card p-10">
            <div className="inline-flex p-5 rounded-2xl bg-blue-50 mb-6">
              <Shield className="w-14 h-14" style={{ color: 'var(--keyvision-blue-start)' }} />
            </div>
            <p className="text-2xl font-bold mb-4" style={{ color: 'var(--keyvision-text-dark)' }}>A dedicated Strata Management plugin is coming soon.</p>
            <p className="text-lg leading-relaxed" style={{ color: 'var(--keyvision-text-light)' }}>
      ...
      <section id="partners" className="py-24 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-5xl mx-auto">
          <div className="keyvision-card p-12 text-center">
            <div className="inline-flex p-5 rounded-2xl bg-blue-50 mb-6">
              <Layers className="w-16 h-16" style={{ color: 'var(--keyvision-blue-start)' }} />
            </div>
            <h2 className="text-4xl sm:text-5xl font-bold mb-6" style={{ color: 'var(--keyvision-text-dark)' }}>Partner with Vivid BMS</h2>
            <p className="text-xl mb-8 leading-relaxed max-w-3xl mx-auto" style={{ color: 'var(--keyvision-text-light)' }}>
            ...
            <Button size="lg" className="text-white text-lg px-10 py-6 font-semibold shadow-lg hover:shadow-xl transition-shadow" style={{ background: 'linear-gradient(to right, var(--keyvision-blue-start), var(--keyvision-blue-end))' }}>
      ...
      <section className="py-24 lg:py-32 px-4 sm:px-6 lg:px-8 keyvision-gradient-bg text-white relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1582407947304-fd86f028f716?q=80&w=2096')] opacity-5 bg-cover bg-center"></div>
        <div className="relative max-w-4xl mx-auto text-center">
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-4 leading-tight">
            Spend less time managing systems.
          </h2>
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-10 leading-tight">
          ...
          <Button size="lg" className="bg-white hover:bg-gray-100 text-lg px-12 py-6 text-xl font-semibold shadow-2xl hover:shadow-xl transition-all" style={{ color: 'var(--keyvision-blue-start)' }}>
            Book a Demo
          </Button>
        </div>
      </section>
      ...
      {/* Footer */}
      <footer className="bg-slate-900 text-gray-400 py-16 px-4 sm:px-6 lg:px-8 border-t border-slate-800">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div>
              <div className="flex items-center gap-2 mb-4">
                <Building2 className="h-7 w-7" style={{ color: 'var(--keyvision-blue-start)' }} />
                <span className="text-white font-bold text-lg">Vivid BMS</span>
              </div>
              <p className="text-sm text-gray-400 leading-relaxed">Building management made simple.</p>
            </div>
            <div>
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li><a href="#whats-next" className="hover:text-white transition-colors">What's Next</a></li>
              </ul>
            </div>
            <div>
